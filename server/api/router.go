...
func createRouter(prefix string, svr *server.Server) *mux.Router {
	...
	router.HandleFunc("/api/v1/hotspot/regions/major", hotStatusHandler.GetHotMajorRegions).Methods("GET")
	router.HandleFunc("/api/v1/hotspot/regions/minor", hotStatusHandler.GetHotMinorRegions).Methods("GET")
